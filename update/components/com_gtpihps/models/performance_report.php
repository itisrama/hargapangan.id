...
class GTPIHPSModelPerformance_Report extends GTModelList{
	...
	protected function getCounts($report_type = null) {
		...
		// Join regency
		$query->join('INNER', $db->quoteName('#__gtpihps_regencies', 'c') . ' ON ' . $db->quoteName('a.regency_id') . ' = ' . $db->quoteName('c.id'));
	...
	public function getRegencies() {
		...
		// Join Market
		$query->join('INNER', $db->quoteName('#__gtpihps_markets', 'b').' ON '.$db->quoteName('a.id').' = '.$db->quoteName('b.regency_id'));
